    ...
    def _get_local_shared_data(self):
        ...
        for client_idx in range(len(self.client_list)):
            ...
            if client_idx == 0:
                ...
                self.global_share_dataset1 = paddle.concat((self.global_share_dataset1, client_data1))
                self.global_share_dataset2 = paddle.concat((self.global_share_dataset2, client_data2))
                self.global_share_data_y = paddle.concat((self.global_share_data_y, data_y))
